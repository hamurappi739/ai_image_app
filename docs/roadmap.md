...
**UX (следующие задачи):** см. [app_design_strategy.md](app_design_strategy.md) — порядок по требованиям руководства (§ **«Ближайший порядок работ»** ниже).
...
| 4 | **Примерное время генерации** в UI — **«Создать»** и **«Фотосессии»** (*«20–60 сек»* / *«до минуты»*) | план |
| 5 | **Расширить «Как получить хороший результат»** на **«Создать»** + примеры описаний | план |
