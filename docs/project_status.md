...
- **Контекстная помощь** (см. выше): 4 блока — готовые идеи, описание, фото (позже), где результат.
...
| 1 | **Карточки фотосессий** — пример результата, цена, «3 фото», описание; рекомендации по фото в sheet | план |
...
- Следующие шаги (UX, см. [roadmap.md](roadmap.md)): **карточки фотосессий** → **рекомендации и примеры фото** → **фото+описание на «Создать»** → **своя фотосессия** → **помощь для «Пакетов»** → **оплата**; затем product mode **`PHOTOSHOOT_OUTPUT_COUNT=3`**
