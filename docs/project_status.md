...
**Режим «Своя сумма» (Flutter UI, без оплаты):** сумма **200–100 000 ₽** → stepper/slider числа фотосессий → остаток ÷ 10 = обычные изображения. Пример **1000 ₽**, **8** фотосессий → **8** фотосессий + **20** изображений; при **0** фотосессий → **100** изображений.
...
- **«Своя сумма»:** поле суммы с валидацией (**мин. 200 ₽**, **макс. 100 000 ₽**); выбор числа фотосессий; live-расчёт остатка в изображения; при невалидной сумме — ошибка и SnackBar *«Введите сумму от 200 ₽»* при нажатии «Оплата скоро».
...
- **Пользовательский баланс (следующий этап):** *«У вас осталось: 12 изображений и 2 фотосессии»* — не «кредиты»; показ в **Профиль** и кратко в **Пакеты** (см. [roadmap.md](roadmap.md)).
...
- Следующие шаги (UX/монетизация, см. [roadmap.md](roadmap.md)): **баланс пользователя** (изображения + фотосессии в UI) → curated-примеры → backend **«Создать»** / **«Своя фотосессия»** → **RuStore** → product mode **`PHOTOSHOOT_OUTPUT_COUNT=3`**
