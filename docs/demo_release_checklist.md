...
| 3 | **Фото по шаблону** | Категории шаблонов; **«Выбрать»** → **Свой запрос** с **длинным** описанием (расширенный текст из [app_prompts.md](app_prompts.md), напр. «Деловой портрет», «Фото товара») |
...
| 18 | **Расширенные промпты — шаблон** | **Деловой портрет** → **Свой запрос**: в поле описания полный текст про деловой образ, свет, сохранение лица |
| 19 | **Расширенные промпты — товар** | **Фото товара** → описание про чистый фон, форму и детали товара |
| 20 | **Расширенные промпты — фотосессия** | **Студийный портрет** → генерация с style prompt (серия из 3); в safe/demo mock — 3 кадра в **Готовые фото** |
| 21 | **Своя фотосессия — чип** | Чип **«Деловой образ»** → в поле описания длинный готовый текст (не одна короткая строка) |
